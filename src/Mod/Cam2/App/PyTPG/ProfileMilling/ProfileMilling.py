...
class ProfileMilling(PyTPGBase):
    ...
    id = 'a27e0486-26a9-11e2-b325-485b39c94df7' #this NEEDS to be unique!!!  @see PyTPGBase.id
    name = 'ProfileMilling' # should match classname
    description = 'This is a simple Profile Milling Operation'
