...
PROPERTY_SOURCE(Drawing::FeatureDrawingPage, App::DocumentObjectGroup)

const char *group = "Drawing view";

FeatureDrawingPage::FeatureDrawingPage(void) 
{
...
FeatureDrawingPage::~FeatureDrawingPage()
{
}

/// get called by the container when a Property was changed
void FeatureDrawingPage::onChanged(const App::Property* prop)
{
    if (prop == &PageResult) {
        if (this->isRestoring()) {
...
App::DocumentObjectExecReturn *FeatureDrawingPage::execute(void)
{
...
//         // try the redirect
//         if (!fi.isReadable()) {
//             Base::Console().Log("FeatureDrawingPage::execute() not able to open %s!\n",Template.getValue());
